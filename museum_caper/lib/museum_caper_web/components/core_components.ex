defmodule MuseumCaperWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MuseumCaperWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MuseumCaperWeb.Gettext, "errors", msg, opts)
    end
  end
